...
//  LightenPocket
//
//  Created by 孙恺 on 14/11/29.
//  Copyright (c) 2014年 sunkai. All rights reserved.
//
#import "JDSideMenu.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIViewController *contentController = [[ZLViewController alloc] init];
...
//    UIViewController *navController = [[UINavigationController alloc] initWithRootViewController:contentController];
    JDSideMenu *sideMenu = [[JDSideMenu alloc] initWithContentController:contentController
